...
def main(zone_bundle, deployment_name, packages_root_directory, output_directory):
...
if __name__ == '__main__':
    ...
    main(zone_bundle, args.deployment_name, args.packages_root_directory, args.output_directory)
